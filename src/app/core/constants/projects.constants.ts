...
export const PROJECTS: Project[] = [
    ...
    },
    {
        ...
        description: [
            ...
            'To catalog our efforts as an group and to centralize media relating to our work, I quickly created a website. All site functionality and styling was done over the course of a weekend using Angular and SCSS, no templates/component libraries. (Not necessarily the best choice but hey!) Additional content was added throughout the summer.',
        ],
        show: true,

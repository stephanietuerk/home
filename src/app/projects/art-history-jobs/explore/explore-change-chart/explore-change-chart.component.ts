...
import { ChangeChartConfig, ChangeChartXAxisConfig, ChangeChartYAxisConfig } from './explore-change-chart.model';
...
export class ExploreChangeChartComponent implements OnInit {
    ...
    getDataMarksConfig(chartData: ExploreChangeChartData): ChangeChartConfig {
        ...
        config.quantitative.valueFormat = this.getQuantitativeValueFormat(chartData);
    ...
    getQuantitativeValueFormat(chartData: ExploreChangeChartData): string {
        return artHistoryFormatSpecifications.explore.chart.value[chartData.dataType];
    }

    getQuantitativeTickFormat(chartData: ExploreChangeChartData): string {
        return artHistoryFormatSpecifications.explore.chart.tick[chartData.dataType];
    }

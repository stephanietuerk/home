...
export const BEYOND_ELECTIONYEARS = [
  ...
  {
    value: ElectionYear.change,
    name: 'Change',
    title: 'Change in Margin, 2012 - 2016',
  },
];

export const BEYOND_ELECTIONTYPES = [
  {
    value: ElectionType.president,
    name: 'President',
    title: 'US Presidential Election Results by Census Tract',
  },
  {
    value: ElectionType.senate,
    name: 'US Senate',
    title: 'US Senate Election Results by Census Tract',
  },
  {
...
export const BEYOND_DEMOYEARS = [
  ...
  {
    value: DemoTime.change,
    name: 'Change 2010-2015',
    title: 'Change, 2010 - 2015',
  },
];
...
export const BEYOND_DEMOTYPES = [
  ...
  {
    value: DemoVariable.income,
    name: 'Income',
    title: 'Income',
    yAxis: 'median income',
    xAxis: 'household income',
  },
];

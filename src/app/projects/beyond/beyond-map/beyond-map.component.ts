...
export class BeyondMapComponent implements OnInit, OnChanges, OnDestroy {
    ...
    makeSvg() {
        this.svg = select(this.divId).append('svg').attr('width', this.width).attr('height', this.height);
    }
        ...
        this.map
            ...
            .style('fill', (d) => {
                ...
                if (!tractData || isNaN(tractData)) {
                    ...
                    const color = tractData >= 0 ? BEYOND_SCALES.vote.r : BEYOND_SCALES.vote.d;
    ...
    onMapZoom() {
        ...
        this.map
            ...
            .attr('x', (d) => {
                return d.geometry.coordinates[0] > -77.1945 ? -7 / zoomScale : 7 / zoomScale;
            })
            .style('text-anchor', (d) => {
                return d.geometry.coordinates[0] > -77.1945 ? 'end' : 'start';
            });
    ...
    resetZoom() {
        this.svg.transition().duration(750).call(this.mapZoom.transform, zoomIdentity);
    }

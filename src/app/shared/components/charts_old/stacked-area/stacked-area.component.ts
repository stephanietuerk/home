...
import { area, extent, InternMap, InternSet, map, range, rollup, scaleOrdinal, select, stack, Transition } from 'd3';
import { UtilitiesService } from 'src/app/core/services/utilities.service';
import { XyContent } from 'src/app/shared/charts/xy-chart/xy-content';

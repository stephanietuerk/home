...
describe('RadioInputComponent', () => {
    ...
    describe('setFormListener', () => {
        ...
        beforeEach(() => {
            ...
            spyOn(component.ngControl.control.valueChanges, 'subscribe').and.callThrough();
        });
        it('subscribes to valueChanges', () => {
            component.setFormListener();
            expect(component.ngControl.control.valueChanges.subscribe).toHaveBeenCalledTimes(1);
        });

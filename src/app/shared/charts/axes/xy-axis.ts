...
import { SvgWrap } from '../utilities/svg-wrap.class';
import { SvgWrapConfig } from '../utilities/svg-wrap.config';
...
export abstract class XyAxis extends Unsubscribe implements OnInit {
    ...
    constructor(
        public chart: XyChartComponent // public xySpace: XyChartSpaceComponent
    ) {
        super();
    }
    ...
    wrapAxisTickText(tickTextSelection: any): void {
        ...
        const config = Object.assign(new SvgWrapConfig(), properties) as SvgWrapConfig;

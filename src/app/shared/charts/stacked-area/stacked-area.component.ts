...
export const STACKED_AREA = new InjectionToken<StackedAreaComponent>('StackedAreaComponent');
...
export class StackedAreaComponent extends XyContent implements XyDataMarks, OnChanges, OnInit {
            ...
            .join(
                (enter) =>
                    enter
                        ...
                        .attr('fill', ([{ i }]) => this.categoryScale(this.values.category[i]))
                        .attr('d', this.area),
                (update) =>
                    update.call((update) =>
                        update

import { geoAlbersUsa, interpolateLab, scaleLinear, scaleQuantile, scaleQuantize, scaleThreshold } from 'd3';
...
export type MapBinType = 'none' | 'equal value ranges' | 'equal num observations' | 'custom breaks';
...
export class EqualValuesQuantitativeAttributeDataDimensionConfig extends AttributeDataDimensionConfig {
    constructor(init?: Partial<EqualValuesQuantitativeAttributeDataDimensionConfig>) {
        super();
        this.valueType = 'quantitative';
...
export class EqualNumbersQuantitativeAttributeDataDimensionConfig extends AttributeDataDimensionConfig {
    ...
    constructor(init?: Partial<EqualNumbersQuantitativeAttributeDataDimensionConfig>) {
        super();
        this.valueType = 'quantitative';
...
export class CustomBreaksQuantitativeAttributeDataDimensionConfig extends AttributeDataDimensionConfig {
    constructor(init?: Partial<CustomBreaksQuantitativeAttributeDataDimensionConfig>) {
        super();
        this.valueType = 'quantitative';

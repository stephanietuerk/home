...
export const LEAVING_OVERVIEW: LeavingQuestion[] = [
    ...
    },
    {
        ...
        a: [
            ...
            "Also, it should go without saying but I'll say anyway that all of this is heavily biased toward my own experiences / what I know. Obviously there are so many ways for people to think through and go through this process, and I am in no way advocating that anything I did is the best or only way.",
        ],
    },
];
...
export const LEAVING_YOU: LeavingQuestion[] = [
    ...
    },
    {
        ...
        a: [
            'I think I may really have only two pieces of advice here. First, don\'t just talk to people, but go try things out, and make use of any (free) services you have available to you wherever you are now. If you are at a university, don\'t be afraid to go talk to other departments / functional groups and take advantage of their workshops, mini-courses, etc. as a way to gain exposure and/or skills. I remember I somehow saw that a Bootcamp with a local location was having a free "intro to something" session (I forget what it even was, maybe actually product design or UX something) that I went to one evening and hated, but it was good to do that and cross it off the list. Read job postings at organizations you think are interesting just to learn what roles exist and what experience / skills they require.',
            "My second piece of advice—which is actually just something that I did that was very useful, but, as with everything, your experience may be very different—was to make a list of characteristics that I wanted in whatever I did next. I had four, and they were very broad—something like, a. work should be more analytic/quantitative in nature than architectural history (which is almost anything, haha), b. work should be involve other people/teamwork (also, more or less any job), c. work should be international in some capacity (my current job which I love is a fail in this regard), and d. ...okay, I actually forget. But something along these lines. If I had to make a fourth now it would be that I didn't want to do work that was in the service of selling something needless. Something like that.",
            'I tried to let these criteria gently serve as a sort of North Star of my search. I was willing to veer of course a bit, but they helped give me a bit of direction when I was also, at the same time, trying to be as open minded as possible, and I think even the exercise of thinking about what I wanted was extremely useful.',
        ],
    },
    {
        ...
        a: [
            "I feel you. There is a catch-22 to all of this which is that people don't want to hire someone without experience and you can't get experience without a job and no one really considers your PhD experience even though you did in fact learn many intangible skills.",
            "That said, now that I am on the other side of the hiring interviews, I thought it may be useful to share perspective that I wish I had had when I was looking for a job. This is perhaps a little hubristic, but I remember feeling like, \"I know I could be good at this job if they would hire me and then I could just pick up skills as I worked. I'm a fast learner!\" (It did turn out to be true, but I think it's also useful to discuss why that's not enough.)",
            'The reality is that for many jobs, the organization is likely to be looking to replace an employee who left and was already performing the job proficiently. And yes, there is always the expectation on onboarding time for anyone new, but generally speaking if they are trying to fill a vacancy, most organization will want some guarantee that their new employee will be able to do the job in a somewhat short period of time, and usually the guarantee they are most comfortable with is experience doing the same thing in a different job.',
            'When I went to Career Services at my university, they suggested I try to turn my academic work into "professional experience" when writing my resume and frankly I think this is just silly. Most organizations where you may be interested in working are going to know what a PhD and that "managed and executed large-scale research project combining multiple archival sources" is just "wrote dissertation." (I mean, a dissertation is that, but it\'s in a different context than in an industry workplace and is...just different.)',
            "So, what to do? I know, I've just been a downer in this question thus far.",
            'But I wrote all of this to say that many organizations just want *some proof* that you can do the work. So my only advice here is to try to get some experience *somehow*.',
            "I remember that in my own talking to everyone phase, I talked to a former French Lang/Lit PhD who transitioned into doing high-level UX/anthro research at a Big Tech Co. She didn't necessarily intend to go in this direction, but she was interested in learning more about UX, started going to Meetups, wound up getting one freelance project from it, which led to another, and then a few more, and then eventually to her position now that she has been in for five years.",
            "I myself got into my field by deciding that I wanted to audit a class at my university when I was a postdoc. At the time it was mostly for personal fulfillment/out of interest, but I was like, 'wow, this is a thing that has a lot of market demand, and that, given my experience, I feel pretty good at, and that I enjoy...maybe I could just...do this? (And then I also got very lucky once I started asking people how I could get freelance work in the field.)",
            "I think that a big concern that employers have, even though it is cliched, about people with PhDs, especially not from lab settings, is whether they can work in a team situation, and I think that any like, three-month thing that you can do that demonstrates that you can work on someone else's project, with other people, is really valuable.",
            'Also, I have to say that being realistic about whether another kind of job can be broken into is likely a good idea. For example, people may be like, "Oh, I have some foreign language skill, and I am a historian, maybe I could get into the think-tank world?" But...think tanks generally have an established pipeline from PhD programs that are relevant to their work, so you would be competing against...other people with PhDs that are a better fit than yours. (I\'m assuming that people with political science PhDs who want to go to think tanks aren\'t reading this because they are good to go with their plans.)',
            '[A bit of an aside: Something that has surprised me about my current job is that I am performing more or less new kind of job function at a company that is very good at what they specialize in but had not really invested in developing capabilities in what I do before. I actually find this remarkably satisfying, and I feel like it makes use of the "can do/learn whatever" scrapiness I developed as a PhD student.]',
            "Finally, I want to add that failing interviews is useful experience! I had one first-round interview that I thought I did okay at but in retrospect completely failed. Someone has just offered to have a first-round interview with me, and I didn't know that much about the job and I didn't really want it and it showed! Why would they hire me over people who were applying with cover letters describing how this was their dream job. BUT, I got to learn something from that interview about the company, about the industry, about what a fine but also kind of bad interview was like, and there would have been no other way for me to get that information without going through it.",
            'I know that none of this is really a good answer for "how do I get around the experience gap", but I don\'t think there is an easy answer, unfortunately. Hopefully understanding an employer\'s perspective is at least a little useful.',
        ],
    },
    {
        id: 'tldr',
